...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const adminNavItems = [
    ...
    { path: '/admin/verification', label: 'Doc Verification', icon: FileCheck },
    { path: '/admin/bulk', label: 'Bulk Operations', icon: Database },
    ...
    { path: '/admin/predictive', label: 'Predictive', icon: TrendingUp },
    { path: '/admin/report-builder', label: 'Report Builder', icon: FileSpreadsheet },
